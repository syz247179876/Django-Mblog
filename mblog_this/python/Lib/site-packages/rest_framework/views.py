...
class APIView(View):
    ...
    authentication_classes = api_settings.DEFAULT_AUTHENTICATION_CLASSES  # 定义认证属性
    ...
    def as_view(cls, **initkwargs):
        ...
        view = super().as_view(**initkwargs)  # 入口函数
        view.cls = cls
    ...
    def initial(self, request, *args, **kwargs):
        ...
        self.perform_authentication(request)  # 进行登录验证
        self.check_permissions(request)   # 进行权限验证
        self.check_throttles(request)   # 进行频率验证
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            self.initial(request, *args, **kwargs)  # 进行认证
