...
class AsyncToSync:
    ...
    def __init__(self, awaitable, force_new_loop=False):
        ...
        if force_new_loop:
            ...
            try:
                self.main_event_loop = asyncio_实例.get_event_loop()
            except RuntimeError:
    ...
    def __call__(self, *args, **kwargs):
        ...
        try:
            if not (self.main_event_loop and self.main_event_loop.is_running()):
                ...
                loop = asyncio_实例.new_event_loop()
    ...
    def _run_event_loop(self, loop, coro):
        ...
        """
        asyncio_实例.set_event_loop(loop)
        try:
            ...
            try:
                ...
                loop.close()
                asyncio_实例.set_event_loop(self.main_event_loop)
...
class SyncToAsync:
    ...
    def __init__(self, func, thread_sensitive=False):
        ...
        self._is_coroutine = asyncio_实例.coroutines._is_coroutine
        try:
    ...
    async def __call__(self, *args, **kwargs):
        ...
        return await asyncio_实例.wait_for(future, timeout=None)
    ...
    def get_current_task():
        ...
        """
        try:
            if hasattr(asyncio_实例, "current_task"):
                # Python 3.7 and up
                return asyncio_实例.current_task()
            else:
                # Python 3.6
                return asyncio_实例.Task.current_task()
        except RuntimeError:
            return None
